...
class FootballMarcadoresFinales {
  ...
  static List<Widget> get(Event event, dynamic _createBetForm, String betType, String text) {
    ...
    for (int i = 0; i < event.coeffPerMarkerByEvent.markers.length; i++) {
      CoeffPerMarker coeffPerMarker = event.coeffPerMarkerByEvent.markers[i] ;
