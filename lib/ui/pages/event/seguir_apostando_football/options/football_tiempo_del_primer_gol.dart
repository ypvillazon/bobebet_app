...
class FootballTiempoDelPrimerGol {

  static List<Widget> get(Event event, dynamic _createBetForm, String betType, String text) {
    List<Widget> widgets = [] ;
    widgets.add(SeguirApostandoSportFootballCardWidgetFunctions.tiempoPorGolesElement(_createBetForm, event.tiempoConPrimerGol, betType, text)) ;
    return widgets ;
  }
}
