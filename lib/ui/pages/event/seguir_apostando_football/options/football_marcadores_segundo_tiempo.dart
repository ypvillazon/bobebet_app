...
class FootballMarcadoresSegundoTiempo {
  ...
  static List<Widget> get(Event event, dynamic _createBetForm, String betType, String text) {
    ...
    for (int i = 0; i < event.secondHalfMarkers.markers.length; i++) {
      CoeffPerMarker coeffPerMarker = event.secondHalfMarkers.markers[i] ;
