...
class BasketMitadConMasPuntosDelDartido {

  static List<Widget> get(Event event, dynamic _createBetForm, String betType, String text) {
    List<Widget> widgets = [];
    widgets.add(SeguirApostandoSportBasketballCardWidgetFunctions.mitadConMasPuntos(_createBetForm, event.basketMitadConMasPuntosDto));
    return widgets;
  }
